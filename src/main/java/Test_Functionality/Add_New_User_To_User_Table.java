...
public class Add_New_User_To_User_Table {
    ...
    @FindBy(xpath = "@FindBy(xpath = \"//span[contains(.,'First Name')]\")")
    private
    WebElement UserList;

    public void Verify_User_List_Table()
    {
        WebDriverWait userlist = new WebDriverWait(driver, 20);
        userlist.until(ExpectedConditions.visibilityOf(AddUserButton));
